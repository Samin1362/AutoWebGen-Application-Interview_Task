      ...
      <div className="max-w-6xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex justify-center items-center">
          <div className="relative w-80 h-80">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-pink-400 to-red-500 rounded-full w-36 h-36 top-4 right-4 opacity-70 animate-bounce" style={{animationDelay: '-2s'}}></div>
            <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-cyan-500 rounded-full w-24 h-24 bottom-12 left-4 opacity-60 animate-bounce" style={{animationDelay: '-4s'}}></div>
          </div>
        </div>
      </div>
    </section>
